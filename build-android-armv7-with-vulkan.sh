...
dir=build-android-armv7-with-vulkan
...
if [ -z $ANDROID_NDK ]; then
  ANDROID_NDK=/Users/jiacheng.du/Code/Toolchain/AndroidNdk/NDK
  # or use
...
if [ -z $VULKAN_SDK ]; then
  VULKAN_SDK=/Users/jiacheng.du/Code/Toolchain/AndroidNdk/NDK/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/
fi
